<%@ Page Title="" Language="C#" MasterPageFile="~/Test/TestMaster.master" AutoEventWireup="true" CodeFile="EncryptReg.aspx.cs" Inherits="Test_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:DropDownList ID="ddlSem" runat="server" Width="200px">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style3">
                <asp:Button ID="btnencrypt" runat="server" BackColor="Lime" BorderColor="Gray" OnClick="btnencrypt_Click" Text="Encrypt" />
            </td>
            <td>
                &nbsp;</td>
            <td>&nbsp;</td>
