...
public partial class Class_23_ListView_ListView_Insert_Update_Delete_ : System.Web.UI.Page
{
    ...
    protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "Update")
        {
            ...
            string updateCommand = "Update [Contacts] set [FirstName]='" + txtFname.Text + "', [LastName]='" + txtLname.Text + "', [ContactType]='" + txtCtype.Text + "' where cid=" + Convert.ToInt32(txtId.Text) + ";";
        ...
        {
            TextBox txtId = (TextBox)e.Item.FindControl("txtUpId");
            string deleteCommand = "delete from [Contacts] where cid=" + Convert.ToInt32(txtId.Text);
