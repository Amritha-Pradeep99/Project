...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    {
        string upQry = "update tbl_cart set delivery_status='1',deliveryagent_name='" + txtname.Text + "',deliveryagent_email='" + txtemail.Text + "',deliveryagent_contact='" + txtcontact.Text + "' where cart_id='" + Session["cartid"] + "'";
        SqlCommand cmd = new SqlCommand(upQry, con);
        cmd.ExecuteNonQuery();

        lblmsg.Text = "Delivery assigned......";
        Response.Redirect("OfferDeliveryStatus.aspx");
    }
}