...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        .btn-secondary {
         ...
         #ContentPlaceHolder1_txtfname {
             margin: 0;
        }
          #ContentPlaceHolder1_txtlname {
             margin: 0;
        }
           #ContentPlaceHolder1_txtphone {
             margin: 0;
        }
            #ContentPlaceHolder1_btnedit {
             margin: 0;
        }
        ...
        <div class="form-container">
            ...
            <div class="form-group-edit">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="txtphone" ErrorMessage="Enter Correct Number"></asp:RequiredFieldValidator>
            </div>
