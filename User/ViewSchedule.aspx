<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="ViewSchedule.aspx.cs" Inherits="User_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">Selected Club</td>
            <td>
                <asp:DropDownList ID="ddlsc" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlsc_SelectedIndexChanged" Width="200px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
