<%@ Page Title="" Language="C#" MasterPageFile="~/User/OfferPayment/OfferPaymentMaster.master" AutoEventWireup="true" CodeFile="OfferFirst.aspx.cs" Inherits="User_OfferPayment_Default" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td style="vertical-align:middle;"> <asp:RadioButton ID="RadioButton1" runat="server" Text="Visa" Checked="True" 
                ...
                <img alt="" class="auto-style19" src="../Icons/1391796960_payment_method_card_visa.png" /> &nbsp;&nbsp; <asp:RadioButton ID="RadioButton2" runat="server" Text="Master Card" 
                    GroupName="1" ValidationGroup="1" Width="108px" CssClass="style5" 
                   /><img alt="" class="auto-style19" src="../Icons/1391796956_payment_method_master_card.png" /></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style30">&nbsp;</td>
