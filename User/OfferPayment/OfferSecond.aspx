<%@ Page Title="" Language="C#" MasterPageFile="~/User/OfferPayment/OfferPaymentMaster.master" AutoEventWireup="true" CodeFile="OfferSecond.aspx.cs" Inherits="User_OfferPayment_Default" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The billing address is used to prevent fraud by matching it to your account information, enter this as close to the way it appears on your card statement
                    ...
                    <tr>
                        <td style="background-color: #99CCFF; text-align: center;"><b>If the billing address is the same as your contact address,then click
                            <asp:LinkButton ID="lblCopyIt" runat="server">Copy It</asp:LinkButton>
                            &nbsp;.</b></td>
                    </tr>
                    <tr>
                        <td >
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style56">
                                        <asp:Button ID="Button1" runat="server" Text="Make Payment" Width="144px" OnClick="Button1_Click" style="font-weight: 700" />
                                    </td>
                                </tr>
                                <tr>
