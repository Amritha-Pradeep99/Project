<%@ Page Title="" Language="C#" MasterPageFile="~/Player/PlayerMaster.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Player_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="form-container">
        ...
        <div class="form-group buttons">
            ...
            <asp:Button ID="btncancel" runat="server" Text="Cancel" class="btn btn-secondary form-control" />
        </div>
